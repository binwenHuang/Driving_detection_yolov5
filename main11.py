...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def window_init(self):
        ...
        self.label_top.setText("疲劳状态")
        self.label_2.setText("疲劳检测：")
        self.label_3.setText("眨眼：0")
        self.label_4.setText("哈欠：0")
            ...
            if len(ret[0])>0:
                ...
                if eye < EYE_AR_THRESH:
                    ...
                    if COUNTER >= EYE_AR_CONSEC_FRAMES:
                        TOTAL += 1
                        window.label_3.setText("眨眼：" + str(TOTAL))
                        # 重置眼帧计数器
                        COUNTER = 0
                ...
                if mouth > MAR_THRESH:
                    ...
                    if mCOUNTER >= MOUTH_AR_CONSEC_FRAMES:
                        mTOTAL += 1
                        window.label_4.setText("哈欠：" + str(mTOTAL))
                        # 重置嘴帧计数器
                        mCOUNTER = 0
                ...
                if Roll == 40:
                    ...
                    if perclos >0.6 and perclos<0.4:
                        # print(perclos)
